...
class Product:
    ...
    def __str__(self) -> str:
        ...
        average score: {self.average_score}<br>
        opinions: <br><br>
        """ + "<br><br>".join(str(opinion) for opinion in self.opinions)

    def __repr__(self) -> str:
        return f"Product(product_id={self.product_id}, product_name={self.product_name}, opinions_count={self.opinions_count}, pros_count={self.pros_count}, cons_count={self.cons_count}, average score={self.average_score}, opinions=[" + ",".join(opinion.__repr__() for opinion in self.opinions) + "])" 
